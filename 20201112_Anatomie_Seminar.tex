...
\begin{frame}
	...
	\centering
	\includegraphics<1>[height=\imheight]{./images/ScanOverviews.104.png}%
	\includegraphics<2>[height=\imheight]{./images/ScanOverviews.24.png}%
\end{frame}	
	...
	\begin{columns}
		...
		\begin{column}{0.618\linewidth}
			...
			\only<1>{%
				...
				\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
					\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{./images/tooth045/Tooth045.mip.rec.png}};
			...
			\only<2>{%
				...
				\begin{tikzpicture}[x=\imagescale,y=-\imagescale]
					\node[anchor=north west, inner sep=0pt, outer sep=0pt] at (0,0) {\includegraphics[width=\imagewidth]{./images/tooth045/Tooth045.mip.rec.crop.png}};
...
\begin{frame}
	...
	\only<2>{%
		\includegraphics[height=\imheight]{./images/tooth045/Tooth045.ExtractedSlices.png}%
		}
	\only<3>{%
		\includegraphics[width=\linewidth]{./images/tooth045/Tooth045.Briseno.png}%
		}
\end{frame}
